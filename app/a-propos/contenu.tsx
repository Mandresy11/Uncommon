...
export function ContenuMaison() {
  return (
    <div className="overflow-x-hidden">
      <section className="grain relative isolate overflow-hidden bg-[#090908] px-6 py-20 text-[#f5f1e8] md:py-28 lg:min-h-[46rem]" aria-labelledby="titre-maison">
        <span
        ...
        <div className="mx-auto grid w-full max-w-6xl min-w-0 items-center gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          <div className="relative z-10 min-w-0">
            ...
            <p className="mt-5 max-w-[34rem] text-[clamp(0.95rem,1.5vw,1.08rem)] leading-[1.8] text-[#f5f1e8]/70">
              ...
              aussi à celles et ceux qui recherchent un vêtement de qualité, chargé de sens,
              pour porter leurs racines avec distinction.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#f1e9dc] px-6 py-20 text-[#191610] md:py-28" aria-labelledby="titre-valeurs">
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl min-w-0">
          <header className="mx-auto max-w-2xl text-center">
            <Kicker>L&apos;ADN de la maison</Kicker>
      ...
      <section id="savoir-faire" className="grain relative isolate scroll-mt-24 overflow-hidden bg-[#0a0908] px-6 py-20 text-[#f5f1e8] md:py-28" aria-labelledby="titre-creation">
        <span
        ...
        <div className="mx-auto grid w-full max-w-6xl min-w-0 items-center gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:gap-20">
          ...
          <div className="min-w-0">
            <Kicker>Notre façon de créer</Kicker>
