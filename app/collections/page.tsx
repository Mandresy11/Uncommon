      ...
      <section className="relative min-h-[54rem] overflow-hidden bg-[#f3ede3] px-5 pb-16 pt-4 md:px-8 lg:pb-12">
        ...
        <div className="relative z-10 mx-auto max-w-[70.5rem]">
          <article className="grid items-start gap-8 lg:grid-cols-[32.5rem_minmax(0,1fr)] lg:gap-[4.5rem]">
            <div className="order-2 relative mx-auto w-full max-w-[28.375rem] lg:order-1 lg:ml-[4.25rem] lg:mr-0">
            ...
            <div className="order-1 mx-auto w-full max-w-[29rem] pt-1 lg:order-2 lg:mx-0 lg:pl-5 lg:pt-11">
            ...
            <div className="order-3 mx-auto w-full max-w-[29rem] lg:hidden">
              <div className="mt-7"><LienCollection /></div>
            </div>
            <div className="order-3 hidden lg:col-start-2 lg:mx-0 lg:block lg:w-full lg:max-w-[29rem] lg:pl-5">
              <div className="mt-7"><LienCollection /></div>
            </div>
          </article>

          <article className="mt-12 grid items-start gap-8 lg:mt-8 lg:grid-cols-[30rem_minmax(0,1fr)] lg:gap-[2.375rem]">
            <div className="order-1 mx-auto w-full max-w-[30rem] lg:mx-0 lg:ml-32 lg:pt-14">
            ...
            <div className="order-2 mx-auto w-full max-w-[36rem] lg:mx-0">
            ...
            <div className="order-3 mx-auto w-full max-w-[30rem] lg:hidden">
              <div className="mt-7"><LienCollection variante="clair" /></div>
            </div>
            <div className="order-3 hidden lg:col-start-1 lg:mx-0 lg:ml-32 lg:block lg:w-full lg:max-w-[30rem]">
              <div className="mt-2"><LienCollection variante="clair" /></div>
            </div>
          </article>
        </div>
      </section>
